        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            ...
            <div className="lg:col-span-3 text-white space-y-4 bg-sky-600 rounded-2xl p-6">
              ...
              <button
                className={`${primaryButtonClasses} rounded-lg px-5 py-2.5 text-sm`}
              >
            ...
            <div className="lg:col-span-4 bg-sky-950 backdrop-blur-sm rounded-2xl p-6 lg:p-8 text-white space-y-5 shadow-xl">
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-center gap-3">
                  <Phone size={18} className="text-sky-300 shrink-0" />
                  <a
              ...
              <button
                className={`${primaryButtonClasses} rounded-lg px-6 py-3 mt-4 w-fit`}
              >
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex space-x-4 pt-2">
                  {/* Facebook */}
                  <Link
                    href="https://www.facebook.com/bloomhealthhospital"
                    target="_blank"
                  ...
                  {/* Instagram */}
                  <Link
                    href="https://www.instagram.com/bloomhealthhospitals"
                    target="_blank"
                    className="w-8 h-8 flex items-center justify-center bg-white/10 rounded-full hover:bg-white/20 transition-colors"
                  >
                    <svg
