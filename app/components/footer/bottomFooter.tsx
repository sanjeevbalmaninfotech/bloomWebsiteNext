...
export default function BottomFooter() {
    return (
        <>
            <footer className="relative bg-[#012840] text-white overflow-hidden">
                ...
                <div className="w-full pointer-events-none overflow-hidden">
                    <h2 className="font-bold leading-[100%] capitalize bg-gradient-to-b from-[#044C78] from-0% via-[#01263C] via-[66.67%] to-[#01263C] bg-clip-text text-transparent whitespace-nowrap" style={{
