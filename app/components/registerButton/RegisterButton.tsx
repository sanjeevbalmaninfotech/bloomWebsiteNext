...
export const RegisterButton = () => {
  ...
  return (
    <Link href="/contact">
      <div
        className="btn btn-primary flex items-center justify-center gap-3 w-full sm:w-fit md:w-fit lg:w-fit max-w-fit bg-gradient-to-r from-[#157DC1] to-[#49acac] text-white px-6 py-3 rounded-lg transition-all duration-300 shadow-lg "
      >
        <span
